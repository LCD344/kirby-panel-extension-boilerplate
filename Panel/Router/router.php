<?php
	namespace BoilerPlate\Panel\Router;

	if (class_exists('panel')) {

		require __DIR__ . '/filters.php'; //import filters

		$userManagerRoutes = require __DIR__ . '/routes.php'; //import routes
		$router = new \Router($userManagerRoutes); // start router
		...
		\BoilerPlate\Panel\Helpers\loadPlugins(['userManager']); // load rest of plugins - important, this has to be AFTER we know our router is going to work
